...
from .views.auth_views import (
    SignUpView, CustomLoginView, CustomPasswordResetView,
    CustomPasswordResetConfirmView, verify_email,
    verify_login_2fa, verify_login_email
)
from .views.profile_views import (
    ProfileView, update_profile_image, update_profile,
    change_password, toggle_2fa, verify_2fa, toggle_email_otp
)
from .views.face_auth_views import (
    face_training, save_face_descriptor, verify_face_login
)
...
urlpatterns = [
    ...
    # Profile URLs
    path('profile/', cache_page(settings.CACHE_TIMEOUT)(ProfileView.as_view()), name='profile'),

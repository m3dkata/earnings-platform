...
from apps.api.views.accounts import UserLoginAPIView, UserLogoutAPIView, UserSignupAPIView, VerifyOTPAPIView
from apps.api.views.notifications import NotificationViewSet
from apps.api.views.operations import OperationDetailAPIView, OperationListCreateAPIView, RateDetailAPIView, RateListCreateAPIView
...
urlpatterns = [
    ...
    path('operations/<int:pk>/', OperationDetailAPIView.as_view(), name='api_operation_detail'),
    ...
    path('payrolls/<int:pk>/', PayrollDetailAPIView.as_view(), name='api_payroll_detail'),

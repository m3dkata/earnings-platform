...
from .views import EmployeeStatsView, LeaveRequestView, LeaveListView, ApproveLeaveView, RejectLeaveView
...
urlpatterns = [
    ...
    path('leave/<int:leave_id>/approve/', ApproveLeaveView.as_view(), name='approve_leave'),
    path('leave/<int:leave_id>/reject/', RejectLeaveView.as_view(), name='reject_leave'),
]

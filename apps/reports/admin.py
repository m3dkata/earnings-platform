...
class ReportAdmin(admin.ModelAdmin):
    list_display = ('number', 'employee', 'date', 'status', 'total_percent', 'total_sum')
    list_filter = ('status', 'date', 'employee')
    search_fields = ('number', 'employee__user__first_name', 'employee__user__last_name')
    readonly_fields = ('number', 'created_at', 'updated_at', 'total_percent', 'total_sum')

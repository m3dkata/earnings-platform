...
class OperationDeleteView(PermissionRequiredMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.error(request, 'Cannot delete this operation as it is being used by other objects')
        return redirect(self.success_url)
...
class RateDeleteView(PermissionRequiredMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.error(request, 'Cannot delete this rate because it is being used by operations')
        return redirect(self.success_url)
